...
void deplacementPion()
{
    ...
    while(ECHEC == 1)
    {
        ...
        {
            printf("caseArrivee ligne : %d  colonne : %d    caseDepart.ligne : %d  colonne %d", caseArrivee.ligne, caseArrivee.colonne, caseDepart.ligne, caseDepart.colonne);
            if((t[caseArrivee.ligne][caseArrivee.colonne]) == (t[caseDepart.ligne - 1][caseDepart.colonne]))
            {
