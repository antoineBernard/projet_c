...
/*
     ...
     Antoine : le module echec et mat est toujours entrain de se faire... le programme est complexe maintenant, il fonctionne sur les pions, et les cavaliers pour     l'instant ;)
            ...
            {   
                ...
                if(t[i][j] == 'c') 
                {
                    ...
                    if(roiNoireSauve == 1)
                     {
                        echecEtMatRoiNoir = 0;
                        printf("le roi noir peut être sauvé par un cavalier\n");
                     }
