...
/*
     ...
     Pour verifCaseChoisie tu proposes quoi ? ^^
...
void testDiagoHG(int i, int j)
{
    ...
    //while( ) ------------------------------>> ICI il faut que tu fasse la boucle de verif
}
