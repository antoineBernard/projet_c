...
/*
     ...
     ps : j'ai galéré à cause des variables globales ><
        --> Faut qu'on discute de ça, j'ai l'impression que tu as un peu perdu de vue le principe de l'échec et mat... Quand est ce que tu seras dispo?
        ...
        {   
           ...
           if(((t[i][j] == 't' || t[i][j] == 'q') && joueurActif == 1) || ((t[i][j] == 'T' || t[i][j] == 'Q') && joueurActif == 2))
           {
            ...
            {  
                ...
                printf("%c a la ligne %d , colonne %d\n", t[i][j], i, j);
                /* je check HG */
