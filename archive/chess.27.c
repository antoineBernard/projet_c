...
void deplacementPiece()
{
    ...
    while(ECHEC == 1 && partietermine == 0)
    {
        ...
        else if(lettreColonne >= 'A' && lettreColonne <= 'H' && numeroLigne >= 1 && numeroLigne <= 8)
        {
                ECHEC = 0;
        ...
        {
            printf("Ca c'est n'importe quoi... Tu es mauvais !\n");
            ECHEC  = 1;
        }
    }    
